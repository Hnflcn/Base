...
namespace Pool
{
	...
	public class FloatingPool : MonoBehaviour
	{
		...
		private Dictionary<FloatingType, Queue<GameObject>> PoolDictionary = new Dictionary<FloatingType, Queue<GameObject>>();
		...
		public GameObject Spawn(FloatingType poolTag, Vector3 position)
		{
		...
		/// <returns>The object found matching the tag specified</returns>
		public GameObject Spawn(FloatingType poolTag, Vector3 position, Quaternion rotation)
		{
			GameObject obj = SpawnFromPool(poolTag);
		...
		/// <returns>The object found matching the tag specified</returns>
		public GameObject Spawn(FloatingType poolTag, Transform parent)
		{
			GameObject obj = SpawnFromPool(poolTag);
		...
		/// <param name="parent">Parent that will be assigned to the object</param>
		/// <returns>The object found matching the tag specified</returns>
		public GameObject Spawn(FloatingType poolTag, Vector3 position, Transform parent)
		{
			GameObject obj = SpawnFromPool(poolTag);
		...
		/// <param name="parent">Parent that will be assigned to the object</param>
		/// <returns>The object found matching the tag specified</returns>
		public GameObject Spawn(FloatingType poolTag, Vector3 position, Quaternion rotation, Transform parent)
		{
			GameObject obj = SpawnFromPool(poolTag);
		...
		private GameObject SpawnFromPool(FloatingType poolTag)
		{
		...
		public void AddToPool(FloatingType poolTag, GameObject prefab, int count)
		{
